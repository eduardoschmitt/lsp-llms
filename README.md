...
Early incremental build. Currently available: syntax core, variables, limitations-guardrail, control-flow, string-function, date/time, conversion, arrays, numeric/math, collections, database, and files slices. See `docs/index.md` for coverage.
