...
Early incremental build. Currently available: syntax core, variables, limitations-guardrail, control-flow, string-function, date/time, and conversion slices. See `docs/index.md` for coverage.
