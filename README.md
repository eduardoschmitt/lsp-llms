...
Early incremental build. Currently available: syntax core, variables, limitations-guardrail, control-flow, string-function, and date/time slices. See `docs/index.md` for coverage.
